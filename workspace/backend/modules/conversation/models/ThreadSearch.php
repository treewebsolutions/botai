...
class ThreadSearch extends DataTableAction
{
	/**
	 * @inheritdoc
	 */
	public function init()
	{
		...
		$this->query = Thread::find()
			...
			->andWhere([
				't.deleted' => isset($this->requestParams['deleted']) ? $this->requestParams['deleted'] : Thread::NO,
			]);
	}
	...
	public function formatData(ActiveQuery $query, $columns)
	{
		return ArrayHelper::toArray($query->all(), [
			Thread::class => [
				'id',
				'action' => function (Thread $model) {
					$actions = [];

					if ($this->requestParams['deleted'] == Thread::YES) {
						if (Yii::$app->user->can('restoreThread')) {
						...
						if (Yii::$app->user->can('deleteThread')) {
						...
						if (Yii::$app->user->can('viewThread')) {
						...
						if (Yii::$app->user->can('updateThread')) {
				...
				'openai_id' => function (Thread $model) {
					return $model->openai_id ?: '&mdash;';
				},
				'created_by' => function (Thread $model) {
					return $model->creator ? $model->creator->username : '&mdash;';
				},
				'created_at' => function (Thread $model) {
					return $model->created_at ? Yii::$app->formatter->asDatetime($model->created_at) : '&mdash;';
				},
				'status' => function (Thread $model) {
