...
$this->title = Yii::t('common', 'View {item}', ['item' => Yii::t('common', 'Thread')]);
...
$this->params['actions'] = [
	...
	[
		'visible' => Yii::$app->user->can('updateThread'),
		'tag' => 'a',
	...
	[
		'visible' => Yii::$app->user->can('deleteThread'),
		'tag' => 'a',
				...
				<?= DetailView::widget([
					...
					'attributes' => [
						...
						[
							...
							'value' => function (Thread $model) {
								$status = Thread::getStatusLabels()[$model->status];
				...
				'clientOptions' => [
					...
					'ajax' => [
						...
						'data' => new JsExpression('function (data) {
							data.model = ' . json_encode(\common\models\Thread::class) . '; 
