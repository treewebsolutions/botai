...
<?php
$this->registerJs('
	$("#dt-languages").on("draw.dt", function () {
        $("#dt-languages").parent().doubleScroll();
		$(".doubleScroll-scroll").width($("#dt-languages").outerWidth());
	});
	$("#dt-languages").on("column-visibility.dt", function () {
        $("#dt-languages").parent().doubleScroll();
		$(".doubleScroll-scroll").width($("#dt-languages").outerWidth());
	});
