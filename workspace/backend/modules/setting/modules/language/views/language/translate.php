...
$this->params['actions'] = [
	[
		'visible' => Yii::$app->user->can('viewLanguage'),
		'tag' => 'a',
		'url' => ['index'],
		'icon' => 'fa fa-list',
		'options' => [
    ...
    [
        'visible' => Yii::$app->user->can('translateIntoLanguage') && Yii::$app->user->can('viewLanguage') && Yii::$app->request->get('id') != 'en-US' && $separators[Yii::$app->request->get('id')],
        'tag' => 'a',
