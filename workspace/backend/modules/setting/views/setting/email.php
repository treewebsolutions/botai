...
$this->title = Yii::t('common', 'Email Settings');
...
<?php $form = ActiveForm::begin([
	...
	<?= $form->field($model, 'useCustomSMTP')->checkbox([
		'data' => [
			'toggle-visibility' => "#smtp-fields",
		],
	]) ?>
	<div id="smtp-fields" class="panel blue-hoki <?= $model->useCustomSMTP ? '' : 'hidden' ?>">
		...
		<div class="panel-body">
			...
			<div class="row">
				<div class="col-sm-6">
					...
					])->textInput()->hint(Yii::t('backend', 'SMTP server. You cannot use {0}.', ['<span class="label label-info">localhost</span>'])) ?>
				</div>
				<div class="col-sm-6">
			...
			<div class="row">
				<div class="col-sm-6">
					...
					])->textInput()->hint(Yii::t('backend', 'Usually {0} or {1} encryption.', ['<span class="label label-info">tls</span>', '<span class="label label-info">ssl</span>'])) ?>
				</div>
			</div>
		</div>
	</div>
