				...
				<?php foreach ($models as $model) : ?>
					<li>
						<a class="notification-item" href="<?= Url::to(['/notification-manager/notification/view', 'id' => $model->id]) ?>">
							...
							<span class="title"><?= $model->title ? Yii::t('notification', $model->title) : Yii::t('common', 'Info') ?></span>
							<span class="time"><?= DateHelper::formatAsRelativeTime($model->created_at) ?></span>
