...
$this->params['actions'] = [
	[
		...
		'options' => [
			...
			'title' => Yii::t('common', 'Notifications'),
			'data' => [
				'toggle' => 'tooltip',
			],
		],
	...
	[
		'visible' => Yii::$app->user->can('updateNotification'),
		'tag' => 'a',
		...
		'attributes' => [
			[
				...
				'value' => function (Notification $model) {
					return Notification::getTypeLabels()[$model->type] ?: '&mdash;';
				},
			],
			[
				'label' => Yii::t('label', 'Title'),
				'value' => function (Notification $model) {
					return $model->title ? Yii::t('notification', $model->title) : '&mdash;';
				},
			],
			[
				'format' => 'html',
			...
			[
				...
				'format' => 'html',
				'label' => Yii::t('label', 'Targeted Users'),
				'value' => function (Notification $model) {
					return implode(', ', ArrayHelper::getColumn($model->users, 'fullName'));
				},
			],
			'created_at:datetime',
			'updated_at:datetime',
