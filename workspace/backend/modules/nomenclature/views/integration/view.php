...
$this->title = Yii::t('common', 'View {item}', ['item' => Yii::t('common', 'Integration')]);
...
$this->params['actions'] = [
	...
	[
		'visible' => Yii::$app->user->can('updateIntegration'),
		'tag' => 'a',
	...
	[
		'visible' => Yii::$app->user->can('deleteIntegration') && !$model->default,
		'tag' => 'a',
				...
				<?= DetailView::widget([
					...
					'attributes' => [
						...
						[
							...
							'value' => function (Integration $model) {
								return $model->type ? Integration::getTypeLabels()[$model->type] : '&mdash;';
							},
						],
						[
							'format' => 'html',
							'label' => Yii::t('label', 'API Key'),
							'value' => function (Integration $model) {
								return $model->data ?: '&mdash;';
							},
						],
						[
							'format' => 'html',
						...
						[
							'format' => 'html',
							'label' => Yii::t('label', 'Sandbox'),
							'value' => function (Integration $model) {
								return Yii::$app->formatter->asBoolean($model->sandbox);
							},
						],
						[
							'format' => 'html',
						...
						[
							...
							'value' => function (Integration $model) {
								$status = Integration::getStatusLabels()[$model->status];
				...
				'clientOptions' => [
					...
					'ajax' => [
						...
						'data' => new JsExpression('function (data) {
							data.model = ' . json_encode(\common\models\Integration::class) . '; 
