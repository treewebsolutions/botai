...
$this->title = Yii::t('common', 'View {item}', ['item' => Yii::t('common', 'Vector Store File')]);
...
$this->params['actions'] = [
	...
	[
		'visible' => Yii::$app->user->can('updateVectorStoreFile'),
		'tag' => 'a',
	...
	[
		'visible' => Yii::$app->user->can('deleteVectorStoreFile') && !$model->default,
		'tag' => 'a',
				...
				<?= DetailView::widget([
					...
					'attributes' => [
						[
							...
							'value' => function (VectorStoreFile $model) {
						...
						[
							'format' => 'html',
							'label' => Yii::t('label', 'OpenAI Status'),
							'value' => function (VectorStoreFile $model) {
						...
						[
							'format' => 'html',
							'label' => Yii::t('label', 'OpenAI Message'),
							'value' => function (VectorStoreFile $model) {
				...
				'clientOptions' => [
					...
					'ajax' => [
						...
						'data' => new JsExpression('function (data) {
							data.model = ' . json_encode(\common\models\VectorStoreFile::class) . '; 
