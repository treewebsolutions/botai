...
$this->title = Yii::t('common', 'View {item}', ['item' => Yii::t('common', 'Vector Store')]);
$this->params['breadcrumbs'] = [
	...
	[
		'label' => Yii::t('common', 'Vector Stores'),
		'url' => ['index'],
	],
	Yii::t('common', 'View'),
];
$this->params['actions'] = [
	[
		'visible' => Yii::$app->user->can('viewVectorStore'),
		'tag' => 'a',
		'url' => ['index'],
		'icon' => 'fa fa-list',
		'options' => [
	...
	[
		'visible' => Yii::$app->user->can('updateVectorStore'),
		'tag' => 'a',
				...
				<?= DetailView::widget([
					...
					'attributes' => [
						[
							...
							'value' => function (VectorStore $model) {
						...
						[
							...
							'value' => function (VectorStore $model) {
								$status = VectorStore::getStatusLabels()[$model->status];
				...
				'clientOptions' => [
					...
					'ajax' => [
						...
						'data' => new JsExpression('function (data) {
							data.model = ' . json_encode(\common\models\VectorStore::class) . '; 
