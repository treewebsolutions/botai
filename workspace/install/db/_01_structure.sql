...
CREATE TABLE IF NOT EXISTS `assistant` (
  ...
  `name` VARCHAR(255) NOT NULL,
  `model` VARCHAR(255) NULL DEFAULT NULL,
  `provider` TINYINT(4) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `assistant_knowledge_base` (
  ...
  INDEX `fk_assistant_knowledge_base_knowledge_base1_idx` (`knowledge_base_id` ASC),
  CONSTRAINT `fk_assistant_knowledge_base_assistant1`
    FOREIGN KEY (`assistant_id`)
    REFERENCES `assistant` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_assistant_knowledge_base_knowledge_base1`
...
CREATE TABLE IF NOT EXISTS `conversation` (
  ...
  `deleted` TINYINT(1) NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  INDEX `openai_conversation_id` (`openai_conversation_id` ASC),
  INDEX `deleted` (`deleted` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `page` (
  ...
  `text` MEDIUMTEXT CHARACTER SET 'utf8' NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `record_vector_index` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `record_id` INT(11) NOT NULL COMMENT 'page.id',
  `openai_file_id` VARCHAR(128) NOT NULL,
  `vector_store_file_id` VARCHAR(128) NULL DEFAULT NULL,
  `vector_store_id` VARCHAR(128) NOT NULL,
  `status` TINYINT(4) NOT NULL DEFAULT 1 COMMENT '0=inactive,1=active,2=error',
  `deleted` TINYINT(1) NOT NULL DEFAULT 0,
  `indexed_at` DATETIME NULL DEFAULT NULL,
  `error_message` TEXT NULL DEFAULT NULL,
  ...
  INDEX `openai_file_id` (`openai_file_id` ASC),
  INDEX `status` (`status` ASC),
  INDEX `deleted` (`deleted` ASC),
  CONSTRAINT `fk_record_vector_index_page1`
