...
class WorkspaceHasUser extends CommonActiveRecord
{
	...
	public function rules()
	{
		return [
			...
			[['created_at', 'updated_at', 'last_activity'], 'safe'],
			[['created_at', 'updated_at', 'last_activity'], 'default'],
			[['auth_key'], 'string', 'max' => 32],
			[['password_hash', 'password_reset_token', 'signup_token', 'username', 'email', 'phone', 'first_name', 'middle_name', 'last_name', 'image'], 'string', 'max' => 255],
