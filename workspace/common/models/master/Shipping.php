 ...
 */
class Shipping extends CommonActiveRecord
{
    /**
     * @inheritdoc
	...
	public function rules()
	{
		return [
			...
			[['method', 'carrier', 'first_name', 'middle_name', 'last_name', 'company', 'tin', 'registration_number', 'address', 'street_name', 'street_number', 'staircase', 'block', 'floor', 'apartment', 'locality', 'zip_code', 'county', 'country', 'phone', 'email', 'fax', 'bank_account', 'bank'], 'string', 'max' => 255],
	...
	public function attributeLabels()
	{
		return [
			...
			'method' => Yii::t('label', 'Method'),
			'carrier' => Yii::t('label', 'Carrier'),
