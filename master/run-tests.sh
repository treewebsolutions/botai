#!/usr/bin/env bash
# Runs the PHPUnit suite for the master app with the repo-pinned PHPUnit 9 PHAR
...
#
# The suite needs the botai_master_test database (schema only), provisioned with:
