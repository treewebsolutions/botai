				...
				<div class="col-md-offset-3 col-md-6">
					<?php $form = ActiveForm::begin([
						...
						<div class="panel-footer text-center">
							<?= Html::submitButton(Yii::t('common', 'Reset Password'), ['class' => 'btn btn-lg btn-block btn-default btn-slide-right']) ?>
						</div>
					<?php ActiveForm::end(); ?>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-6">
					<?php $form = ActiveForm::begin([
						...
						<div class="panel-footer text-center">
							<?= Html::submitButton(Yii::t('common', 'Request Code'), ['class' => 'btn btn-lg btn-block btn-default btn-slide-right']) ?>
						</div>
					<?php ActiveForm::end(); ?>
				</div>
				<div class="col-md-6">
					<?php $form = ActiveForm::begin([
						...
						<div class="panel-footer text-center">
							<?= Html::submitButton(Yii::t('common', 'Validate Code'), ['class' => 'btn btn-lg btn-block btn-default btn-slide-right']) ?>
						</div>
					<?php ActiveForm::end(); ?>
				</div>
			</div>
