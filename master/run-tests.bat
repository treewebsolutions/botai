@echo off
rem Runs the PHPUnit suite for the master app, using the repo-pinned PHPUnit 9
...
rem
rem The suite needs the botai_master_test database (schema only):
rem   bash tools\load-test-schema.sh master
