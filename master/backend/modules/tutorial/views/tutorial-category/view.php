...
$this->title = Yii::t('common', 'View {item}', ['item' => Yii::t('common', 'Tutorial Category')]);
...
$this->params['actions'] = [
	...
	[
		'visible' => Yii::$app->user->can('updateTutorialCategory'),
		'tag' => 'a',
...
<?= DetailView::widget([
	...
	'attributes' => [
        [
            ...
            'value' => function (TutorialCategory $model) {
				...
				'clientOptions' => [
					...
					'ajax' => [
						...
						'data' => new JsExpression('function (data) {
							data.model = ' . json_encode(TutorialCategory::class) . '; 
