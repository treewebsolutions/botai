			...
			<div class="row">
				<div class="col-sm-4">
					<?= $form->field($model, 'status')->widget(Select2::class, [
						'data' => ArrayHelper::getColumn(TutorialCategory::getStatusLabels(), 'label'),
						'pluginLoading' => false,
						'pluginOptions' => [
							'allowClear' => false,
            ...
            <div class="row">
                <div class="col-sm-12">
                    <?= $form->field($model, 'parent_id')->widget(Select2::class, [
                        ...
                        'data' => ArrayHelper::map(TutorialCategory::findAllAvailableCategories($model->id), 'id', 'treeName'),
                        'maintainOrder' => true,
                        'showToggleAll' => false,
                        'pluginLoading' => false,
                        'pluginOptions' => [
