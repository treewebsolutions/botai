	...
	<div class="row">
		<div class="col-sm-3">
			<?= $form->field($model, 'status')->widget(Select2::class, [
				'data' => ArrayHelper::getColumn(FollowupMarketingCampaign::getStatusLabels(), 'label'),
				'pluginLoading' => false,
				'pluginOptions' => [
		...
		<div class="col-sm-3">
			<?= $form->field($model, 'event')->widget(Select2::class, [
				'data' => FollowupMarketingCampaign::getEventLabels(),
				'pluginLoading' => false,
				'pluginOptions' => [
					'placeholder' => Yii::t('common', 'Choose'),
				],
		...
		<div class="col-sm-4">
			<?php $cycleField = $form->field($model, 'cycle', [
				...
				'data' => \common\models\ScheduledTask::getCycleLabels($model->frequency != 1 ? 'plural' : null),
				'pluginLoading' => false,
				'pluginOptions' => [
					'placeholder' => Yii::t('common', 'Choose'),
				],
			...
			<?= $form->field($model, 'frequency', [
				'template' => '{label}<div class="row row-no-gutters row-custom"><div class="col-xs-6">{input}</div>' . $cycleField . '</div>{error}{hint}',
			...
			])->hint(Yii::t('backend', 'Elapsed time from triggering event to sending messages.')) ?>
		</div>
        <div class="col-sm-2">
