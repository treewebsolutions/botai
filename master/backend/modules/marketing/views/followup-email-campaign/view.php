...
$this->params['actions'] = [
	...
	[
		'visible' => Yii::$app->user->can('updateFollowupMarketingCampaign'),
		'tag' => 'a',
	...
	<?= DetailView::widget([
		...
		'attributes' => [
			[
				...
				'value' => function (FollowupMarketingCampaign $model) {
			...
			[
				'format' => 'html',
				'label' => Yii::t('label', 'Sent Messages'),
				'value' => function (FollowupMarketingCampaign $model) {
					return count(array_filter($model->marketingCampaignHasRecipients, function ($marketingCampaignHasRecipient) {
						return $marketingCampaignHasRecipient->sent_at != null;
					}));
				},
			],
			[
				'format' => 'html',
				'label' => Yii::t('label', 'Start Interval'),
				'value' => function (FollowupMarketingCampaign $model) {
