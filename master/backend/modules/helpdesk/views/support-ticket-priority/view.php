...
$this->title = Yii::t('common', 'View {item}', ['item' => Yii::t('common', 'Support Ticket Priority')]);
...
$this->params['actions'] = [
	...
	[
		'visible' => Yii::$app->user->can('updateHelpdeskSupportTicketPriority'),
		'tag' => 'a',
	...
	[
		'visible' => Yii::$app->user->can('deleteHelpdeskSupportTicketPriority') && !$model->default,
		'tag' => 'a',
	...
	<?= DetailView::widget([
		...
		'attributes' => [
			[
				...
				'value' => function (SupportTicketPriority $model) {
				...
				'clientOptions' => [
					...
					'ajax' => [
						...
						'data' => new JsExpression('function (data) {
							data.model = ' . json_encode(\common\models\SupportTicketPriority::class) . '; 
