...
$this->title = Yii::t('common', 'View {item}', ['item' => Yii::t('common', 'Support Ticket Department')]);
...
$this->params['actions'] = [
	...
	[
		'visible' => Yii::$app->user->can('updateHelpdeskSupportTicketDepartment'),
		'tag' => 'a',
	...
	[
		'visible' => Yii::$app->user->can('deleteHelpdeskSupportTicketDepartment') && !$model->default,
		'tag' => 'a',
	...
	<?= DetailView::widget([
		...
		'attributes' => [
			[
				...
				'value' => function (SupportTicketDepartment $model) {
				...
				'clientOptions' => [
					...
					'ajax' => [
						...
						'data' => new JsExpression('function (data) {
							data.model = ' . json_encode(\common\models\SupportTicketDepartment::class) . '; 
