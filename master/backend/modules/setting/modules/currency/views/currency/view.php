...
$this->title = Yii::t('common', 'View {item}', ['item' => Yii::t('common', 'Currency')]);
		...
		'attributes' => [
			[
				...
				'value' => function (Currency $model) {
					return $model->iso_code ?: '&mdash;';
				},
			],
			[
				'label' => Yii::t('label', 'Symbol'),
				'value' => function (Currency $model) {
					return $model->symbol ?: '&mdash;';
				},
			],
			[
			...
			[
				...
				'value' => function (Currency $model) {
					$status = Currency::getStatusLabels()[$model->status];
				...
				'clientOptions' => [
					...
					'ajax' => [
						...
						'data' => new JsExpression('function (data) {
							data.model = ' . json_encode(Currency::class) . '; 
