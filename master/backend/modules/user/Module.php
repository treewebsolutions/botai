		...
		return [
			...
			'items' => [
				[
					'roles' => ['viewUser'],
					'icon' => 'fa fa-circle-o',
					'label' => Yii::t('common', 'Operators'),
					'url' => ['/user-manager/operator-user/index'],
				],
                [
                    'roles' => ['viewUser'],
                    'icon' => 'fa fa-circle-o',
                    'label' => Yii::t('common', 'Subscribers'),
                    'url' => ['/user-manager/subscriber-user/index'],
                ],
				[
					'roles' => ['viewUserRole'],
					'icon' => 'fa fa-circle-o',
					'label' => Yii::t('common', 'Roles'),
					'url' => ['/user-manager/role/index'],
				],
			],
		];
	}
