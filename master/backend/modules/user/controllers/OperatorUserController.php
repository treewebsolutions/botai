...
use backend\modules\user\models\OperatorUserForm;
use backend\modules\user\models\OperatorUserSearch;
...
class OperatorUserController extends MainController
{
	/**
	 * @inheritdoc
	 */
		...
		return [
			'access' => [
				...
				'rules' => [
					[
						'allow' => true,
						'actions' => ['index', 'view', 'dt-operator-users', 'find-existing-users'],
						'roles' => ['viewUser'],
					],
					[
						'allow' => true,
	...
	{
		return [
			'dt-operator-users' => OperatorUserSearch::class,
		];
	}
	...
	{
		$model = $this->findModel($id, OperatorUserForm::class);
		$result = true;
	 ...
	 * @return \yii\db\ActiveQuery|\yii\db\ActiveRecord|User|OperatorUserForm
	 * @throws NotFoundHttpException if no model was found
	 */
