...
$this->title = Yii::t('common', 'View {item}', ['item' => Yii::t('common', 'Service Category')]);
...
$this->params['actions'] = [
	...
	[
		'visible' => Yii::$app->user->can('updateServiceCategory'),
		'tag' => 'a',
...
<?= DetailView::widget([
	...
	'attributes' => [
		[
			...
			'value' => function (ServiceCategory $model) {
		...
		[
			...
			'value' => function (ServiceCategory $model) {
				$status = ServiceCategory::getStatusLabels()[$model->status];
				...
				'clientOptions' => [
					...
					'ajax' => [
						...
						'data' => new JsExpression('function (data) {
							data.model = ' . json_encode(ServiceCategory::class) . '; 
