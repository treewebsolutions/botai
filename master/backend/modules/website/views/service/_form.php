...
<?php $form = ActiveForm::begin([
	...
	<div class="form-body <?= Yii::$app->request->isAjax ? 'modal-content' : '' ?>">
		...
		<div class="form-fields <?= Yii::$app->request->isAjax ? 'modal-body' : '' ?>">
			<div class="row">
				<div class="col-sm-3">
					<?= $form->field($model, 'status')->widget(Select2::class, [
						'data' => ArrayHelper::getColumn(Service::getStatusLabels(), 'label'),
						'pluginLoading' => false,
						'pluginOptions' => [
							'allowClear' => false,
			...
			<?= $form->field($model, 'service_category_id')->widget(Select2::class, [
				'options' => [
					'multiple' => true,
				],
				'data' => ArrayHelper::map(\common\models\ServiceCategory::findAllServiceCategories(), 'id', 'translation.title'),
				'maintainOrder' => true,
				'showToggleAll' => true,
				'toggleAllSettings' => [
