...
$this->title = Yii::t('common', 'View {item}', ['item' => Yii::t('common', 'Article Category')]);
...
$this->params['actions'] = [
	...
	[
		'visible' => Yii::$app->user->can('updateArticleCategory'),
		'tag' => 'a',
	...
	[
		'visible' => Yii::$app->user->can('deleteArticleCategory'),
		'tag' => 'a',
	...
	[
		'visible' => Yii::$app->user->can('createArticleCategory'),
		'tag' => 'a',
		'url' => ['create'],
		'icon' => 'fa fa-plus',
		'options' => [
				...
				'clientOptions' => [
					...
					'ajax' => [
						...
						'data' => new JsExpression('function (data) {
							data.model = ' . json_encode(ArticleCategory::class) . '; 
