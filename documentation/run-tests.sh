#!/usr/bin/env bash
# Runs the PHPUnit suite for the documentation app with the repo-pinned PHPUnit 9 PHAR
...
#
# The suite needs the botai_documentation_test database (schema only), provisioned with:
