@echo off
rem Runs the PHPUnit suite for the documentation app, using the repo-pinned PHPUnit 9
...
rem
rem The suite needs the botai_documentation_test database (schema only):
rem   bash tools\load-test-schema.sh documentation
