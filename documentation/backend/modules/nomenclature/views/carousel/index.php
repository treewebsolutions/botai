...
<?php
$this->registerJs('
	$("#dt-carousels").on("draw.dt", function () {
        $("#dt-carousels").parent().doubleScroll();
		$(".doubleScroll-scroll").width($("#dt-carousels").outerWidth());
	});
	$("#dt-carousels").on("column-visibility.dt", function () {
        $("#dt-carousels").parent().doubleScroll();
		$(".doubleScroll-scroll").width($("#dt-carousels").outerWidth());
	});
