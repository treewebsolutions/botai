...
$this->params['actions'] = [
	[
		'visible' => Yii::$app->user->can('restoreEmailTemplate') && $showTrash,
		'tag' => 'button',
		'icon' => 'fa fa-undo',
		'options' => [
			...
			'data' => [
				...
				'dt-table' => '#dt-email-templates',
			],
		],
	],
	[
		'visible' => Yii::$app->user->can('deleteEmailTemplate'),
		'tag' => 'button',
		'icon' => 'fa fa-trash',
		'options' => [
...
//		],
		'columns' => [
			...
			[
				'data' => 'variant',
				'title' => Yii::t('label', 'Variant'),
				'filter' => ['select', Template::getVariantLabels()[Template::TYPE_EMAIL]],
			],
			[
				'data' => 'default',
