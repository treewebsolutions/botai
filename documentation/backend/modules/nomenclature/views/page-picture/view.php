...
$this->title = Yii::t('common', 'View {item}', ['item' => Yii::t('common', 'Picture')]);
...
$this->params['actions'] = [
	...
	[
		...
		'tag' => 'a',
		'url' => ['update', 'id' => $model->id, 'page_id' => $page_id],
		'icon' => 'fa fa-edit',
		'options' => [
	...
	[
		...
		'tag' => 'a',
		'url' => ['delete', 'id' => $model->id, 'page_id' => $page_id],
		'icon' => 'fa fa-trash',
		'options' => [
				...
				'clientOptions' => [
					...
					'ajax' => [
						...
						'data' => new JsExpression('function (data) {
							data.model = ' . json_encode(Picture::class) . '; 
