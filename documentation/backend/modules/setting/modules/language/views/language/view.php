...
$this->title = Yii::t('common', 'View {item}', ['item' => Yii::t('common', 'Language')]);
...
<div class="table-responsive">
	<?= DetailView::widget([
		...
		'attributes' => [
			...
			[
				'format' => 'html',
				'label' => Yii::t('label', 'Name Ascii'),
				'value' => function (Language $model) {
					return $model->name_ascii;
				},
			],
			[
				'format' => 'html',
				...
				'clientOptions' => [
					...
					'ajax' => [
						...
						'data' => new JsExpression('function (data) {
							data.model = ' . json_encode(Language::class) . '; 
							data.model_key = "' . $model->language_id . '";
						}'),
